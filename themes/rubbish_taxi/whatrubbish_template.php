<?php 
/*Template Name: What Rubbish Temlate*/
?>
<?php get_header(); ?>
<div class="jumbotron cus_jumbotron service-area-cus_jumbotron areax">
    	<div class="container jumbotron-content">
        	<div class="row top-portion">
            <?php if ( function_exists ( dynamic_sidebar('Banner Section For What Rubbish Page') ) ) : ?>
						<?php dynamic_sidebar ('Banner Section For What Rubbish Page'); ?>
                        <?php endif; ?> 
