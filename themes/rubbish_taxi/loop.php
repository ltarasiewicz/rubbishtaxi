...
<?php /* How to display all other posts. */ ?>
	...
	<div class="blog-post blog">
                    ...
                    <h1 class="sub-header1"><a class='blog_header' href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'twentyten' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h1>
                    <div class="blog-content">
                       <?php echo strlen(substr(get_the_content(),0,100)) ?substr(get_the_content(),0,200).'&hellip;&nbsp;&nbsp;' : get_the_content().'&nbsp;&nbsp;'; ?>
                    </div>
                    <span class="pull-left comment-count"><?php comments_popup_link( __( 'Leave a comment', 'twentyten' ), __( 'Comments 1', 'twentyten' ), __( 'Comments %', 'twentyten' ) ); ?></span>
...
<div class="row placeholders comments">
                    <div class="col-xs-12 placeholder">
                        <div class="pagination">
                            <div class="pgin-left"><?php previous_posts_link( __( 'Newer posts', 'twentyten' ) ); ?></div>
                            <div class="pgin-right pull-right"><?php next_posts_link( __( 'Older posts', 'twentyten' ) ); ?></div>                       
                          </div>
                    </div>
                </div>
