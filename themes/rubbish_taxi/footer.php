...
?>
	<div class="container footer">
       ...
       <div class="col-sm-6">
       		<div class="row ">
           	<div class="col-md-8 placeholder hidden_mobile">
               	<ul class="">
                   	<?php if ( function_exists ( dynamic_sidebar('Copyright Section') ) ) : ?>
            ...
            <div class="col-md-4 placeholder">
            	<ul>
   	                <?php if ( function_exists ( dynamic_sidebar('Address Section') ) ) : ?>
						<?php dynamic_sidebar ('Address Section'); ?>
                        <?php endif; ?>
                </ul>
            </div>
           </div>
       ...
       <div class="col-sm-6">
       		...
       		<div class="col-md-6 placeholder hidden_desk ">
            ...
            <div class="col-md-6 placeholder ">
            	 <ul>
                     <?php if ( function_exists ( dynamic_sidebar('Contact Section') ) ) : ?>
            ...
            <div class="col-md-6 placeholder hidden_tab ">
            	<?php if ( function_exists ( dynamic_sidebar('Follow Section') ) ) : ?>
						<?php dynamic_sidebar ('Follow Section'); ?>
                        <?php endif; ?>
            </div>
...
<!-- Google Tag Manager -->
<noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-57Q7K6"
